...
PARFUM_CSV = BASE_DIR / "dataset" / "parfum" / "perfumes_rows.csv"
OUT_INTERAKSI = BASE_DIR / "dataset" / "interaksi" / "dataset_rating_variatif.csv"
OUT_PROFIL = BASE_DIR / "dataset" / "interaksi" / "profil_user_dummy.csv"

# =========================================================
# LOAD DATA PARFUM
# =========================================================
df_parfum = pd.read_csv(PARFUM_CSV)
...
# PARAMETER DATASET
# =========================================================
num_users = 800   # [Batch 5] dinaikkan dari 500 -> 800 untuk merapatkan data & kurangi sparsity CF
